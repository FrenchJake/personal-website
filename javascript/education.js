...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const images = [
    "../images/educationpage/Bama2.jpeg",
    "../images/educationpage/Bama3.jpg",
    "../images/educationpage/Bama4.jpg",
    "../images/educationpage/Bama5.jpg",
    "../images/educationpage/BamaGame.png"
  ];
